...
__conda_setup="$('/home/marko/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/marko/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/marko/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/marko/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
FG_PURPLE="\\[$(tput setaf 207)\\]"
BG_PURPLE="\\[$(tput setab 207)\\]"
...
PS1="$BG_PURPLE"
PS1+=" \u ${FG_PURPLE}$BG_COLOR5$RESET"
PS1+="$FG_COLOR1"
PS1+="$BG_COLOR5 \\W "
PS1+="$RESET${FG_COLOR6}"
PS1+="$BG_EXIT$RESET"
